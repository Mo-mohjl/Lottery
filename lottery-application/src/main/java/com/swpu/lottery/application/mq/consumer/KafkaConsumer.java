...
import com.swpu.lottery.domain.award.service.factory.DistributionGoodsFactory;
...
public class KafkaConsumer {
    ...
    public void onMessage(ConsumerRecord<?, ?> record, Acknowledgment ack, @Header(KafkaHeaders.RECEIVED_TOPIC) String topic){
        ...
        try {
            ...
            DistributionRes distributionRes = distributionGoodsService.distributionRes(new GoodsReq(invoiceVO.getuId(), invoiceVO.getOrderId(), invoiceVO.getAwardId(), invoiceVO.getAwardName(), invoiceVO.getAwardContent()));
